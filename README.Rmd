...
# twitterbot
This package accesses documents from the [Open Archive HAL](https://hal.archives-ouvertes.fr/) and tweets the last scientific publications from the CRP2A laboratory. It can be used with a cron job to schedule tweets on a daily/weekly basis.
